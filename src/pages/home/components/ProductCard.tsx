...
export default function ProductCard(props) {
  ...
  const handleAddToCart = () => {
    updateCart({_id: props._id,image: props.image, name: props.name, price: props.price, description: props.description});
  ...
  return (
    <div className="h-[432px] relative">
      ...
      <div className="mt-4">
        ...
        <div className="mt-2">
          <button onClick={handleAddToCart} className="border-2 border-black rounded-lg px-4 py-1 text-lg mt-4 font-medium hover:bg-black hover:text-white transition">
            Add To Cart
          </button>
        </div>
      </div>
