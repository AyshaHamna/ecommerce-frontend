...
function CheckoutPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      clearCart();
      toast.success("Successfully placed order, ", order._id);
        ...
        <div className="col-span-2 p-2 rounded-md ">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mt-6 mb-2">
              <button className="border-2 border-black rounded-lg px-4 py-1 text-lg mt-4 font-medium hover:bg-black hover:text-white transition">
                Proceed to Payment
              </button>
            </div>
          </form>
        ...
        <div className="col-span-1 border p-2 rounded-md">
          ...
          {cart.map((el, index) => {
            return (
              <div
                key={index}
                className="grid grid-cols-3 border p-2 my-3 rounded-xl"
              >
